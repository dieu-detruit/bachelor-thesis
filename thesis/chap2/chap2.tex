...
\subfloat[Rayleigh-Sommerfeld回折積分とFresnel回折積分の比較]{
    \includegraphics[width=8cm]{diffraction_comparison_profile.png}
    \label{fig:diffraction_comparison_profile}
}
\subfloat[Rayleigh-Sommerfeld回折積分とFresnel回折積分の差分値]{
    \centering
    \includegraphics[width=8cm]{diffraction_comparison_diff.png}
    \label{fig:diffraction_comparison_diff}
}
