...
\begin{figure}[!ht]
\centering
\includegraphics[width=13cm]{lens_experiment_schematic.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=12cm]{psuedo_focusing_ring.png}
...
\subfloat[全体概観]{
    \centering
    \includegraphics[width=6cm]{photo_lens_experiment_overall.png}
    \label{fig:lens_experiment_photo_overall}
}
\subfloat[ピンホールおよび集光レンズ]{
    \centering
    \includegraphics[width=6cm]{photo_pinhole_and_lens.png}
    \label{fig:lens_experiment_photo_pinhole_and_lens}
}
